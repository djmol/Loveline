...
// Source: Unity's 2D Platformer example project
public class BackgroundParallax : MonoBehaviour
{
    ...
    Transform cam;						// Shorter reference to the main camera's transform.
    Vector3 previousCamPos;				// The postion of the camera in the previous frame.
